...
execute as @a[scores={game_state=1..6,lobal_delay=0}] run function au:tasktps
...
#### Updating every x ticks ###

# Match Start
execute as @a[scores={game_state=0},limit=1] run function au:game_setup

# Match End
execute as @a[scores={game_state=7},limit=1] run function au:match_end

# Round Start
execute as @a[scores={game_state=1,global_delay=0..},limit=1] run function au:round_start

# Imposter Uses
execute as @a[scores={game_state=2,global_delay=0..}] run function au:imposter_uses/vent_tp
execute as @a[scores={game_state=2,global_delay=0}] run function au:imposter_uses/lamps

execute as @a[scores={game_state=2,global_delay=0..},limit=1] run function au:imposter_uses/killlogic

# Check For Tasks
execute as @a[scores={game_state=2,global_delay=5},limit=1] run function au:tasks/check
#execute as @a[scores={game_state=2,global_delay=5,in_task=1..},limit=1] run function au:tasks/check
#execute as @a[scores={game_state=2,global_delay=15,task_request=1..},limit=1] run function au:tasks/check
execute as @a[scores={game_state=2,global_delay=15},limit=1] run function au:tasks/check
function au:sounds

# Check For Sabotages
execute as @a[scores={game_state=2,global_delay=0},tag=imposter,limit=1] run function au:sabotages/check
execute as @a[scores={game_state=2,global_delay=10},tag=imposter,limit=1] run function au:sabotages/check

# Misc 
execute as @a[scores={game_state=2,global_delay=1}] run function au:room_maps
...
# Meetings
execute as @a[scores={game_state=2,global_delay=0..},limit=1] run function au:meetings/report
execute as @a[scores={game_state=2,global_delay=0..},tag=!ghost,limit=1] run function au:meetings/emergency

# Voting
execute as @a[scores={game_state=3,global_delay=1},limit=1] run function au:voting/voting_init
execute as @a[scores={game_state=4,global_delay=1},limit=1] run function au:voting/get_votes
execute as @a[scores={game_state=5,global_delay=1},limit=1] run function au:voting/count_votes
execute as @a[scores={game_state=6,global_delay=0..},limit=1] run function au:voting/voted_out

# Reset Scores
execute as @a[scores={game_state=2,global_delay=19,carrot_noises=1..,in_task=0}] run scoreboard players set @s carrot_noises 0
execute as @a[scores={game_state=2,global_delay=19},limit=1] run scoreboard players set @a task_request 0

# Update Cooldowns
execute as @a[scores={game_state=2,global_delay=17},limit=1] run function au:update_cooldowns
...
setblock 98 69 -57 minecraft:jack_o_lantern
...
setblock 98 69 -58 minecraft:oak_wall_sign{Color:white,Text1:"\"made half a pet\"",Text2:"\"or something\"",Text3:"\"idk\""}
...
#/execute as @a[limit=1] if score range global_delay matches 0 run scoreboard players set range global_delay 4
