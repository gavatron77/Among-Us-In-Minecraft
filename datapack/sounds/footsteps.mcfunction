...
#execute at @e[tag=Room4] as @a[scores={step_time=1},tag=in_game,distance=..9] at @s run playsound minecraft:entity.ghast.ambient player @s ~ ~ ~ 10
#execute at @e[tag=Room5] as @a[scores={step_time=1},tag=in_game,distance=..11] at @s run playsound minecraft:entity.ghast.ambient player @s ~ ~ ~ 10
#execute at @e[tag=Room6] as @a[scores={step_time=1},tag=in_game,distance=..25] at @s run playsound minecraft:entity.ghast.ambient player @s ~ ~ ~ 10
#execute at @e[tag=Room7] as @a[scores={step_time=1},tag=in_game,distance=..9] at @s run playsound minecraft:entity.ghast.ambient player @s ~ ~ ~ 10
#execute at @e[tag=Room8] as @a[scores={step_time=1},tag=in_game,distance=..5] at @s run playsound minecraft:entity.ghast.ambient player @s ~ ~ ~ 10
#execute at @e[tag=Room9] as @a[scores={step_time=1},tag=in_game,distance=..8] at @s run playsound minecraft:entity.dolphin.swim player @s ~ ~ ~ 10
...
#execute at @e[tag=Room11] as @a[scores={step_time=1},tag=in_game,distance=..10] at @s run playsound minecraft:entity.ghast.ambient player @s ~ ~ ~ 10
#execute at @e[tag=Room12] as @a[scores={step_time=1},tag=in_game,distance=..5] at @s run playsound minecraft:entity.ghast.ambient player @s ~ ~ ~ 10
#execute at @e[tag=Room13] as @a[scores={step_time=1},tag=in_game,distance=..13] at @s run playsound minecraft:entity.ghast.ambient player @s ~ ~ ~ 10
#execute at @e[tag=Room14] as @a[scores={step_time=1},tag=in_game,distance=..12] at @s run playsound minecraft:entity.ghast.ambient player @s ~ ~ ~ 10
#
