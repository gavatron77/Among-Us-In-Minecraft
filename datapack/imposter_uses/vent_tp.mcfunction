...
execute as @a[tag=down,tag=!ghost] at @s run playsound minecraft:entity.enderman.death master @s ~ ~ ~
...
execute as @a[tag=up,tag=!ghost] at @s run playsound minecraft:entity.enderman.death master @s ~ ~ ~
